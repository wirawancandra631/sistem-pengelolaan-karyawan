...
import { useShowEmploye, useUpdateEmploye } from '../../../useFetch/useEmployeApi';
import { useFetchJobDesk } from '../../../useFetch/useJobDeskApi';
function EmployeEditDataPage() {
  const { id } = useParams();
  const { data: dataEmploye } = useShowEmploye(id);
  const { error, updateData } = useUpdateEmploye();
  ...
  useEffect(() => {
    if (dataEmploye) {
      setForm({
        ...form,
        employe_nik: dataEmploye.employe_nik,
        employe_sallary_basic: dataEmploye.employe_sallary_basic,
        employe_name: dataEmploye.employe_name,
        employe_gender: dataEmploye.employe_gender,
        employe_born_date: dataEmploye.employe_born_date,
        employe_email: dataEmploye.employe_email,
        employe_number_phone: dataEmploye.employe_number_phone,
        job_desk_id: dataEmploye.job_desk_id ? dataEmploye.job_desk_id : '',
        employe_status: dataEmploye.employe_status,
        employe_work_entry: dataEmploye.employe_work_entry,
        employe_work_leave: dataEmploye.employe_work_leave,
        employe_allowance: dataEmploye.employe_allowance,
        employe_address: dataEmploye.employe_address
      });
    }
  }, [dataEmploye]);
  return (
    <section className="w-full p-10">
      ...
      <form action="" className="mt-5" onSubmit={handleUpdate}>
        <div className="mb-3">
          <p className="font-bold text-2xl">Edit Data Karyawan</p>
        </div>
        <div className="mb-3">
            ...
            <div className="w-[33%] mx-2">
              ...
              <div className="w-full flex items-center border border-slate-300">
                ...
                <input
                  ...
                  required
                  value={form.employe_sallary_basic}
          ...
          <div className="flex mb-3">
            ...
            <div className="w-1/2">
              ...
              <input
                ...
                value={form.employe_number_phone}
...
export default EmployeEditDataPage;
